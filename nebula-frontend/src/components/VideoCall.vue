    ...
    <div class="flex-1 relative overflow-hidden">
      ...
      >
        <div class="text-center text-white max-w-md mx-auto p-8">
          ...
          <div class="bg-gray-800 px-4 py-3 rounded-xl">
            <p class="font-mono font-bold text-2xl tracking-wider text-purple-400">
              {{ roomInfo?.short_code }}
            </p>
          </div>
          <button
            @click="copyRoomCode"
            class="mt-4 bg-purple-500 hover:bg-purple-600 text-white px-6 py-2 rounded-lg transition-colors inline-flex items-center space-x-2"
          >
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                stroke-linecap="round"
      ...
      <div
        ...
        :class="[
          ...
          webrtcStore.isVideoEnabled ? 'border-purple-400' : 'border-gray-600',
        ]"
